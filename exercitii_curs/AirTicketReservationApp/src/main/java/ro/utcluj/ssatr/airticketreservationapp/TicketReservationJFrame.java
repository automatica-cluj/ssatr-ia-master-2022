 ...
 * @author mihai.hulea
 */
public class TicketReservationJFrame extends javax.swing.JFrame {
     ...
     */
    public TicketReservationJFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketReservationJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketReservationJFrame().setVisible(true);
            }
        });
    }
